...
<body>
  ...
  <form method="post" action="update.php">
    <div class="form-group">
      ...
      <input type="text" class="form-control" id="task" name="task" placeholder="Enter task" value="<?= $rs['task'] ?>" disabled="disabled">
    </div>
    <div class="form-group">
      <label for="deadline">Deadline</label>
      <input type="date" class="form-control" id="deadline" name="deadline" value="<?= $rs['deadline'] ?>" disabled="disabled">
    </div>
    <div class="form-group">
